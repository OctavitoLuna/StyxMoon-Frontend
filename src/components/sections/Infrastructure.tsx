      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="lg:w-1/2">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">Infraestructura <span className="text-gradient">Deep Tech</span></h2>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={idx} className="flex gap-5 items-start group">
                  <div className="p-3.5 rounded-sm bg-[var(--bg-secondary)] border border-[var(--card-border)] text-[var(--accent-primary)] group-hover:bg-[var(--accent-primary)] group-hover:text-white transition-all duration-300 shadow-sm">
          ...
          <div className="lg:w-1/2 relative">
            ...
            >
              <div className="glass-card p-8 shadow-[0_8px_30px_rgba(15,23,42,0.08)] relative overflow-hidden rounded-sm border-t-4 border-t-[var(--accent-secondary)]">
                {/* Subtle background glow */}
                <div className="absolute -top-20 -right-20 w-64 h-64 bg-[var(--accent-primary)] opacity-10 rounded-sm blur-3xl"></div>

                {/* Header */}
                <div className="flex justify-between items-center mb-8 border-b border-[var(--card-border)] pb-5 relative z-10">
                  <div className="flex items-center gap-3">
                    <div className="p-2 bg-[var(--bg-secondary)] rounded-sm border border-[var(--card-border)]">
                  ...
                  <div className="flex items-center gap-2 bg-emerald-500/10 px-3 py-1.5 rounded-sm border border-emerald-500/20">
                    <span className="relative flex h-2 w-2">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                      <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
                    </span>
                    <span className="text-xs font-mono font-medium text-emerald-600 dark:text-emerald-400 uppercase tracking-widest">Operational</span>
                  </div>
                </div>

                {/* Metrics Grid */}
                <div className="grid grid-cols-2 gap-4 mb-8 relative z-10">
                  <div className="bg-[var(--bg-secondary)] p-5 rounded-sm border border-[var(--card-border)] hover:border-[var(--accent-primary)] transition-colors duration-300">
